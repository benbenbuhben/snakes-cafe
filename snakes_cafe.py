...
def print_category(menu, selected_category, width):
    print('INPUT', menu, selected_category, width)
    output = '\n'
    for category in menu:
        for key, value in category.items():
...
def run():
    ...
    if initial_input == '2':
        ...
        MENU = [{'Appetizers': [{'Wings': 7}, {'Cookies': 3}, {'Spring Rolls': 5},          {'Rocky Mtn Oysters': 8}, {'Awesome Blossom Possom': 10}]},
            ...
            {'Desserts': [{'Ice Cream': 5}, {'Cake': 6}, {'Pie': 6}, {'Salmon Cookie': 4}]}, {'Drinks': [{'Coffee': 3}, {'Tea': 3}, {'Blood of the Innocent': 4}, {'Beer': 4}, {'Irish Coffee': 5}, {'Purple Drank': 3}]}]
